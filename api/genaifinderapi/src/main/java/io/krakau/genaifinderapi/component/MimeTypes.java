...
public class MimeTypes {
    ...
    private static HashMap<String, String> mimeTypeMapping = new HashMap<String, String>();
    private static HashMap<String, String> extMapping = new HashMap<String, String>();
    ...
    public MimeTypes() {
        ...
        mimeTypeMapping.put("webp", MIME_IMAGE_WEBP);
        ...
        extMapping.put(MIME_IMAGE_WEBP, "webp");
